...
class Multi_ConvTransformer(pl.LightningModule):
    def __init__(self, input_dim=17, output_dim=1, feature_embed_dim = 32, demo_dim = 4, demo_hidden_dim = 32, num_channels=[4,8,16,32], attention_hidden_dim=32, kernel_size=4, keep_prob=0.5, nhead=4, num_layers=3):
        super().__init__()
        # hyperparameters
